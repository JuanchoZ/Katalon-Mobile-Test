...
WebUI.setEncryptedText(findTestObject('Object Repository/Application/WebGfi/Page_Login - My Store/input_Password_passwd'), 
    'HeCM15nHKBI=')

WebUI.setText(findTestObject('Object Repository/Application/WebGfi/Page_Login - My Store/input_Email address_email'), 'jmag4')
